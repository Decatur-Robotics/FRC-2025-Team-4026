...
public class PathSetpoints {
    ...
    public final static Pose2d REEF_B = new Pose2d(0, 5, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_C = new Pose2d(2, 10, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_D = new Pose2d(5, 2, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_E = new Pose2d(5, 5, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_F = new Pose2d(5, 10, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_G = new Pose2d(10, 0, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_H = new Pose2d(10, 5, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_I = new Pose2d(10, 10, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_J = new Pose2d(15, 0, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_K = new Pose2d(15, 5, Rotation2d.fromDegrees(0));
    public final static Pose2d REEF_L = new Pose2d(15, 10, Rotation2d.fromDegrees(0));
