...
public class AutoConstants {
    ...
    public static final Pose2d BLUE_LEFT_INITIAL_POSE = new Pose2d(7.23, 7.53, Rotation2d.kZero);
    public static final Pose2d BLUE_CENTER_INITIAL_POSE = new Pose2d(7.23, 4.026, Rotation2d.kZero);
    public static final Pose2d BLUE_RIGHT_INITIAL_POSE = new Pose2d(7.23, 0.52, Rotation2d.kZero);

    public static final Pose2d RED_LEFT_INITIAL_POSE = new Pose2d(10.31, 0.52, Rotation2d.k180deg);
